...
class anaPencereWidget(QWidget):
    ...
    def ipAra(self):
        try:
            ...
            print(self.kontrolEdilecekIpAdresleri)
            if len(self.kontrolEdilecekIpAdresleri[0]) >= 1:
                for ip in self.kontrolEdilecekIpAdresleri:
                    ...
                    if ip not in cgnatIpAdresi:
                        cgnatIpAdresiDegil.append(ip)

                print('cgnatda olan ip adresleri: '+str(cgnatIpAdresi))
                print('cgnatda olmayan ip adresleri: ' + str(cgnatIpAdresiDegil))
